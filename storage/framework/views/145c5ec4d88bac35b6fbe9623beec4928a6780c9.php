...
<body>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo e(url('/submenu')); ?>">
                                <i class="fas fa-table"></i>Add Recipes</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/showrecipe')); ?>">
                                <i class="far fa-check-square"></i>Show Recipes</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <script>
        $.ajaxSetup({
            headers:{
                'X-CSRF-TOKEN':$('meta[name="casrf-token"]').attr('content')
            }
        });
    </script>
